...
- Visual Elements:
  _ A vertical progress bar displays the current percentage of the curl.
 _ The current count of curls is displayed at the bottom left corner.
_ FPS is shown in the top left corner to monitor real-time performance.
